    ...
    def forward(self, x):
        ...
        Args:
            x (torch.Tensor): The input tensor of raycasts. 
                              Expected shape: (batch_size, num_rays)
        """
        # Add a channel dimension for the Conv1d layers. Shape becomes (batch_size, 1, num_rays)
        x = x.unsqueeze(1)
...
#     def __init__(self, num_rays):
#         super().__init__()
#         self.visual_cnn = HelperCNN(num_rays)
